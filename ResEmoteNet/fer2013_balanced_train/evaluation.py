...
test_dataset = Four4All(csv_file=r'test_labels.csv',
                        img_dir=r'fer2013_balanced_restructured/test', transform=transform)
test_loader = DataLoader(test_dataset, batch_size=16, shuffle=False)
test_image, test_label = next(iter(test_loader))

# List of saved model paths
model_paths = [
    r"D:\Alex\Documents\Master\An 2\Dizertatie\ResEmoteNet\fer2013_balanced_train\snapshots\best_test_model.pth",
