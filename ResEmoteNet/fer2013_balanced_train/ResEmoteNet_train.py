...
train_dataset = Four4All(csv_file=r'train_labels.csv',
                         img_dir=r'fer2013_balanced_restructured/train', transform=transform)
train_loader = DataLoader(train_dataset, batch_size=16, shuffle=True)
train_image, train_label = next(iter(train_loader))

val_dataset = Four4All(csv_file=r'val_labels.csv',
                       img_dir=r'fer2013_balanced_restructured/val', transform=transform_evaluation)
val_loader = DataLoader(val_dataset, batch_size=16, shuffle=True)
val_image, val_label = next(iter(val_loader))

test_dataset = Four4All(csv_file=r'test_labels.csv',
                        img_dir=r'fer2013_balanced_restructured/test', transform=transform_evaluation)
