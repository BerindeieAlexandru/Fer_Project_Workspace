...
source_dir = 'fer2013_balanced_renamed'  # Directory with current structured format
destination_dir = 'fer2013_balanced_restructured'  # New base directory for flattened structure
...
print("Images successfully copied to the new directory structure in 'fer2013_balanced_restructured'.")
