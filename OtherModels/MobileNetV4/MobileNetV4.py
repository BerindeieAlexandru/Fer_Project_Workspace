...
def main():
    ...
    model = timm.create_model('mobilenetv4_hybrid_large.e600_r384_in1k', pretrained=True, num_classes=num_classes).to(device)
    ...
    checkpoint = torch.load('mobilenetv4_best.pth')
