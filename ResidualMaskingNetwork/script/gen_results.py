...
model_dict = [
    # ("resnet34", "resnet34_test_2024May28_12.14")
    ...
    # ("resmasking_dropout1", "resmasking_dropout1_test_2024May30_07.55"),
]
...
def main():
    ...
    for model_name, checkpoint_path in model_dict:
        ...
        if os.path.exists("..\\saved\\{}.npy".format(checkpoint_path)):
            continue

        model = getattr(models, model_name)
        model = model(in_channels=3, num_classes=7)

        state = torch.load("../checkpoint/cbam_resnet50_test_2024May31_04_balanced.46")
        ...
        np.save("..\\saved\\{}.npy".format(checkpoint_path), prediction_list)
